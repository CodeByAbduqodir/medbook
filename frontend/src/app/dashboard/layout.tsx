...
const NAV_ITEMS: NavItem[] = [
  { href: "/dashboard", label: "Umumiy", icon: <LayoutDashboard size={18} /> },
  { href: "/dashboard/appointments", label: "Mening qabullarim", icon: <Calendar size={18} /> },
  { href: "/dashboard/prescriptions", label: "Retseptlar", icon: <FileText size={18} /> },
  { href: "/dashboard/profile", label: "Profil", icon: <UserCircle size={18} /> },
];
