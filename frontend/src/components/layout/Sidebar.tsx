...
export function Sidebar({ navItems, title = "MedBook" }: SidebarProps) {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden lg:flex flex-col w-64 shrink-0 h-screen sticky top-0 bg-white dark:bg-gray-950 border-r border-gray-100 dark:border-gray-800">
        <NavContent />
      </aside>
        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              className="lg:hidden fixed inset-y-0 left-0 z-50 w-72 bg-white dark:bg-gray-950 flex flex-col"
            >
              <button
                onClick={() => setMobileOpen(false)}
